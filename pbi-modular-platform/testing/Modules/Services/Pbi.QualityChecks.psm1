function Get-PbiQualityRuleCatalog {
    return @(
        ...
        [PSCustomObject]@{ Scope = "Module"; RuleId = "architecture.module.semantic-namespace.required"; Description = "Semantic modules must keep tables in the MOD or _MOD package namespace and match their classification contract."; Severity = "Error" },
        ...
        [PSCustomObject]@{ Scope = "Module"; RuleId = "semantic.dax.spaced-table-reference.quoted"; Description = "Semantic DAX references quote table names that contain spaces."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Module"; RuleId = "semantic.table-visibility.standard"; Description = "semanticUx keeps exactly one visible facade table and marks technical tables hidden with the _MOD prefix in both source and rendered TMDL assets."; Severity = "Error" },
        ...
        [PSCustomObject]@{ Scope = "Module"; RuleId = "report.render.succeeds"; Description = "Dynamic report assets can be rendered and parsed before installation."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Module"; RuleId = "report.binding-token.unresolved"; Description = "Report assets do not contain unresolved framework binding tokens."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Module"; RuleId = "report.binding-placeholder.forbidden"; Description = "Rendered report assets do not contain unresolved MOD_BIND placeholders."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Module"; RuleId = "report.slicer.static-filter.forbidden"; Description = "Package slicers do not ship with static visual filter state; available options must come from package selector tables alone."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Module"; RuleId = "report.field-parameter.slicer-shape.valid"; Description = "Field-parameter slicers keep the nested filter/decomposed identity payload shape required by Power BI Desktop."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Module"; RuleId = "report.projection.reference-consistent"; Description = "Visual projections keep field/measure references aligned with queryRef metadata."; Severity = "Error" },
        ...
        [PSCustomObject]@{ Scope = "Project"; RuleId = "semantic.binding-token.unresolved"; Description = "Installed semantic definitions do not contain unresolved framework binding tokens."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Project"; RuleId = "semantic.tmdl.literal-escape.forbidden"; Description = "Installed semantic TMDL definitions do not contain literal PowerShell escape sequences."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Project"; RuleId = "semantic.dax.spaced-table-reference.quoted"; Description = "Installed semantic DAX references quote table names that contain spaces."; Severity = "Error" },
        ...
        [PSCustomObject]@{ Scope = "Project"; RuleId = "report.binding-token.unresolved"; Description = "Installed report assets do not contain unresolved framework binding tokens."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Project"; RuleId = "report.binding-placeholder.forbidden"; Description = "Installed report assets do not contain unresolved MOD_BIND placeholders."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Project"; RuleId = "report.slicer.static-filter.forbidden"; Description = "Installed package slicers do not ship with static visual filter state."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Project"; RuleId = "report.field-parameter.slicer-shape.valid"; Description = "Installed field-parameter slicers keep the nested filter/decomposed identity payload shape required by Power BI Desktop."; Severity = "Error" },
        [PSCustomObject]@{ Scope = "Project"; RuleId = "report.projection.reference-consistent"; Description = "Installed visuals keep field/measure references aligned with queryRef metadata."; Severity = "Error" },
