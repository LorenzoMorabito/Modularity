...
- Stato: `prototype`
- Rendering strategy: `flex-flat`
- Compatibilita consumer dichiarata: `marketing/product-analysis-core`, `marketing/product-analysis-flextable`
- Descrizione: Reusable flat table module with collection-based dimension and metric binding.
...
- Espone una facade table business-facing: `MOD Flex Flat`.

## Cosa installa
- Tabella semantic: `MOD Flex Flat`
- Tabella semantic: `_MOD Flex Flat Dimensions`
- Tabella semantic: `_MOD Flex Flat Measures`
- Tabelle tecniche nascoste dichiarate: `_MOD Flex Flat Dimensions`, `_MOD Flex Flat Measures`
- Tabella facade visibile: `MOD Flex Flat`
- Report page: `Flexible Flat Table` (`9c7a5b4d3e2f1a0b6c8d`)
...
- Descrizione: Choose the descriptive dimensions exposed by the flat table.
- Default `Dimension 1`: Primary descriptive dimension; valore suggerito `T_DIM_COUNTRY[Country]`; suggerimenti `Country`, `Market`, `Region`
- Default `Dimension 2`: Secondary descriptive dimension; valore suggerito `T_DIM_PRODUCT[Product]`; suggerimenti `Product`, `Brand`, `SKU`
- Default `Dimension 3`: Additional descriptive dimension; valore suggerito `T_DIM_CORPORATION[Corporation]`; suggerimenti `Corporation`, `Company`, `Business Unit`
- Default `Dimension 4`: Additional descriptive dimension; valore suggerito `T_DIM_MOLECULE[MoleculeNorm]`; suggerimenti `Molecule`, `Ingredient`, `Diagnosis`
- Default `Dimension 5`: Additional descriptive dimension; valore suggerito `T_DIM_QUARTER[QuarterKey]`; suggerimenti `Quarter`, `Month`, `Period`
- Default `Dimension 6`: Additional descriptive dimension; valore suggerito `T_DIM_ACT4[ATC4]`; suggerimenti `ATC4`, `Class`, `Segment`
...
- Descrizione: Choose the measures exposed by the flat table.
